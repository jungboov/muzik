...
function response() {
	if (httpRequest.readyState == 4) {
		if (httpRequest.status == 200) {
			...
			//  3|홍길동^010-1111-1111^Java,홍길,홍길
...
<form name="search" action="./faq/list.jsp" method="post">
<div class="container">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
		<div class="input-group">
	  	  <input type="text" name="keyword" id="keyword" onkeydown="startSuggest()" class="form-control" placeholder="검색할 팀원 이름">
		  <div class="input-group-btn">
 		  	  <button class="btn btn-default" type="button" onclick="javascript:frmSend(this.form);">
  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3" id="suggest">
    </div>
  </div>

  <div class="row">
    <div class="col-md-6 col-md-offset-3" id="suggestList">
    </div>
  </div>
</div>
</form>
