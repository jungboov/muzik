...
<body>
	...
	<FORM name='frm' method='POST' action='./update'
		...
		<TABLE width="800" class="table1">
			<TR>
				<TD class="td1"><input style="width: 625px;" type="text"
					name="title" value="${dto.title }"></TD>
			</TR>
			<TR>
				<TD class="td1"><textarea rows="10" cols="105" name="content">${dto.content}</textarea>
				</TD>
			</TR>
		</TABLE>
		...
		<DIV class='bottom'>
			<input type='submit' class="btn btn-primary" value='수정'> <input
				type='button' class="btn btn-danger" value='취소' onclick="blist()">
