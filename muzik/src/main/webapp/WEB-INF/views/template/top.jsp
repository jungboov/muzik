		...
		<div id="menubar" class="w3-center w3-container" data-spy="affix" data-offset-top="43" style="padding-left: 0px; padding-right: 0px;">
			<div class="w3-row w3-xlarge" id="row">
				<ul style="list-style-type: none" id="top_menu">
					...
					<li class="w3-col m2">
						<a id="top_a5" class="top_a" style="color: black;" >
							<span class="w3-border-0">고객지원센터</span>
						</a>
					</li>
					<li class="w3-col m2">
						<a id="top_a6" class="top_a" style="color: black;" >
			...
			<div class="w3-center " id="panel">
				<ul style="list-style-type: none" id="list_menu">
					...
					<li class="w3-col m2">
						<ul style="list-style-type: none; margin-left: -18px">
							<li>
								<a class="w3-text-white" href="${pageContext.request.contextPath}/bbs/list?col=&word=&nowPage=1">
									<span class="w3-border-0">자유게시판</span>
								</a>
							</li>
							<c:if test="${sessionScope.id!=null}">
								<li>
									<a class="w3-text-white" href="${pageContext.request.contextPath}/bbs/create">
					...
					<li class="w3-col m2">
						<ul style="list-style-type: none">
							<li>
								<a class="w3-text-white" href="${pageContext.request.contextPath}/guest/list?col=&word=&nowPage=1">
									<span class="w3-border-0">방명록</span>
								</a>
							</li>
							<c:if test="${sessionScope.id!=null}">
								<li>
									<a class="w3-text-white" href="${pageContext.request.contextPath}/guest/create">
										<span class="w3-border-0">글쓰기</span>
									</a>
								</li>
							</c:if>
					...
					<li class="w3-col m2">
						<ul style="list-style-type: none">
							<li>
								<a class="w3-text-white" href="${pageContext.request.contextPath}/faq/list">
									<span class="w3-border-0">F A Q</span>
								</a>
							</li>
							<li>
								<a class="w3-text-white" href="${pageContext.request.contextPath}/qna/list">
					...
					<li class="w3-col m2">
						<ul style="list-style-type: none">
							...
							<li>
								<a class="w3-text-white" id="memberlist" href="${pageContext.request.contextPath }/admin/list">
