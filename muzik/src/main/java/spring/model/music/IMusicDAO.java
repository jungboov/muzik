...
public interface IMusicDAO extends DAOSTDInter {
	 ...
	 * @return
	 */
	public List<ChartDTO> weekList(int week); 
	/**
	 * 월간 차트
	 * @param week
	 * @return
	 ...
	 * @return
	 */
	public List<String> urlList(int week);
	/**
	 * 선택한 곡 추가
	 * @param map
	 * @return
	 ...
	 * @return
	 */
	public ChartDTO read(String weekid);
	/**
	 * 보관함에서 재생 목록을 위한 해당 곡 정보 읽기
	 * @param weekid
	 * @return
	 */
	 ...
	 * @return
	 */
	public List<Integer> scroll_week(String separator);
	/**
	 * 차트생성
	 * @param dto
	 * @return
